...
//     if (!device) {
//         console.error('WebGPU not supported, trying fallback webgl2');
//         let webgl = canvas.getContext('webgl2', { antialias: true });
//         if (!webgl) {
//             console.error('WebGL2 not supported, abborting setup');
//             return
//         } else {
//             return webgl
//         }
...
//     let webgpu = canvas.getContext('webgpu');
...
// let gl = initGL();
// if (!gl) {
//     console.error('No compatible graphics library found');
//     // Return
// }
...
//     shaderManager.createShaderPackage('planet2d', ShaderMap['planet2d.vert'], ShaderMap['planet2d.frag']);
//     shaderManager.createProgram('planet', 'planet');
//     shaderManager.createProgram('background', 'background');
//     shaderManager.createProgram('planet2d', 'planet2d');
...
//     // let planet3D = new Planet3D(gl, shaderManager, 1, subdivisions, utils.createMat4());
//     let planet2D = new Planet2D(gl, shaderManager)
...
//         planet2D.setShaderProgram('planet2d');
//         shaderManager.assignTexture(gl.getUniformLocation(shaderManager.getProgram('planet2d')!, 'uPlanetTexture')!, planetTexture, 1);
//         planet2D.setBuffers();
//         planet2D.render();

//         // planet3D.setShaderProgram('planet');
//         // planet3D.setModelMatrix(
//         //     [xPlanetPosition, 0, 0],
...
//     texturePlanetUrl: '/textures/barren00.jpg',
//     texturePlanetIsCompressed: false,
...
//     // Planet clouds information
//     cloudColor: new Color(255,255,255,0),
//     cloudRotation: -15.0,
